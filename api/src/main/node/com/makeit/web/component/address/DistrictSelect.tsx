...
interface DistrictSelectProps extends WrappedComponentProps {
    region?: number;
}

@observer
class DistrictSelect extends React.Component<DistrictSelectProps> {
    ...
    public async UNSAFE_componentWillReceiveProps(nextProps: DistrictSelectProps) {
...
export default injectIntl(DistrictSelect);
