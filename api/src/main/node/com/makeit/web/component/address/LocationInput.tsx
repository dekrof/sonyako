...
import MapGL, { Marker, DragEvent } from "react-map-gl";
import { GeolocatedProps, geolocated } from "react-geolocated";
import { injectIntl, WrappedComponentProps } from "react-intl";

import { flow, observable } from "mobx";
import { observer } from "mobx-react";
import { once, delay } from "helpful-decorators";
    ...
    public componentDidMount() {
        if (!this.props.isGeolocationEnabled) {
            notification.open({
                ...
                icon: <UserNavigator width={30} height={30} />
            });
        } else {
        ...
        return (
            <div className="address-form-map-wrapper ant-input">
                <MapGL {...this.viewport}
                    ...
                    onViewportChange={(vieport: Viewport) => {this.viewport = vieport; this.showLocationConfirm = false;}}
