...
@module(UserModule) @observer
export class UserPanel extends React.Component<WrappedComponentProps> {
                ...
                render={() => (
                    <Form layout="vertical" className="signup-form">
                        ...
                        <Space direction="horizontal" align="start" size={20} className="signup-form-avatar-space">
                            ...
                            <div>
                                <p>
                                    <Link to="/">Make IT</Link> doing the best to provide a quality avatar picture for your profile.
                                        Every time, while you entering the new username the new unique avatar will be immediately ready for your choice.
                                    </p>
                                <Divider />
                                <p>
