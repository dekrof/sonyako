export default {
    ...
    "login.username.placeholder": "Введіть ім'я користувача чи e-mail",
    "login.username.error": "Ім'я користувача чи e-mail введено не вірно",
    "login.password": "Пароль",
    "login.password.placeholder": "Введіть Ваш пароль",
    "login.password.error": "Невірний пароль",
    "login.sign-in": "Ввійти",
