            ...
            <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="tw-card-body"
                        ...
                        <p style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                            <span
                                style="font-weight: 400;">
                                Please click the below button to change your password for
                                <strong>Customer Engagement App</strong>.
                                The link will be valid for next ${expirationTime} minutes.
                            </span>
                        </p>
                        <br/>
                        <br/>
                                        ...
                                        <tr>
                                            <td class="button__td "
                                                ...
                                                <a
                                                    ...
                                                    class="button__a"
                                                    target="_blank"
                                                    style="border-radius: 4px; color: #FFFFFF; display: block; font-family: sans-serif; font-size: 18px; font-weight: bold; mso-height-rule: exactly; line-height: 1.1; padding: 14px 18px; text-decoration: none; text-transform: none; border: 1px solid #316FEA;">
                                                </a>
                                                <![endif]-->
                                                <!-- [if !mso]><!-->
                                                <a
                        ...
                        <p class=""
                           style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                            ...
                            &nbsp;
                            <a style="color: #316fea; text-decoration: none;"
                        ...
                        <p class="tw-signoff"
                           style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                            Our best, <br/> The Customer Engagement App team
                        </p>
                    </td>
                </tr>
                </tbody>
